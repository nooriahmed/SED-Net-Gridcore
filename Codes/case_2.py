...
Original file is located at
    https://colab.research.google.com/drive/1v_q2F2s5_RpFc_smPKYqhWZOn9rIs6dd
"""
...
print("\nClassification Report:")
print(classification_report(y_test, y_pred_labels, target_names=['Grid', 'Battery', 'Biomass', 'Wind'])) #Solar

# Confusion Matrix Plot
plt.figure(figsize=(6, 5))
cm = confusion_matrix(y_test, y_pred_labels)
sns.heatmap(cm, annot=True, fmt='d', cmap='YlGnBu',
            xticklabels=['Grid', 'Battery', 'Biomass', 'Wind'], #Solar
            yticklabels=['Grid', 'Battery', 'Biomass', 'Wind']) #Solar
